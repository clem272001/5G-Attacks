...
if __name__ == "__main__":
    ...
    transform_file_with_scaler("dataset_1_filtered.csv", "dataset_1_final.csv", scaler, columns_to_scale, exclude_cols=exclude_att, chunksize=chunksize, sep=sep)
    transform_file_with_scaler("dataset_2_filtered.csv", "dataset_2_final.csv", scaler, columns_to_scale, exclude_cols=exclude_att, chunksize=chunksize, sep=sep)
    transform_file_with_scaler("dataset_3_filtered.csv", "dataset_3_final.csv", scaler, columns_to_scale, exclude_cols=exclude_att, chunksize=chunksize, sep=sep)
