    ...
    with open(input_file, newline='', encoding="utf-8") as infile, \
        ...
        for row in reader:
            ...
            if hdr_len:
                try:
                    if float(hdr_len) > 20:
                        if capture == "capture_flood_attack_1min.csv":
                            new_value = 0
                        elif capture == "capture_deletion_attack_1min_10ues.csv":
                            new_value = 1
                        elif capture == "capture_modification_attack_1min_13ues.csv":
                            new_value = 2
                         ...
                         #   new_value = 3
                        if row.get("ip.src") in ('192.168.14.187', '192.168.14.131'):
                            new_value = 3
